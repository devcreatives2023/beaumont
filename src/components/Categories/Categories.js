    ...
    <div className="grid gird-cols-1 xl:grid-cols-2 lg:grid-cols-2 md:grid-cols-2 gap-[80px]">
      {data.category.map((item, index) => {
          return (
              ...
              >
            <img src={item.img} className="h-[300px]  xl:h-[500px]  lg:h-[400px] md:h-[200px] transition-[0.2s] ease-in-out contrast-[0.8] cursor-pointer  object-cover hover:contrast-[1]" />
