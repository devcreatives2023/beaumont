...
const Category = () => {
  return (
    ...
    className="mt-[50px]">
      ...
      className="xl:w-[50%] lg:w-[50%] xl:text-[21px] lg:text-[21px] text-[16px] md:text-[18px]">
      ...
      <motion.p 
        ...
        className="xl:w-[51%] lg:w-[50%] md:w-[55%]  mt-[50px] xl:text-[21px] lg:text-[21px] text-[16px] md:text-[18px]">
